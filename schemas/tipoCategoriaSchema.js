...
let tipoCategoriaSchema = new Schema({
    ...
    nombreCategoria: {
        ...
        type: String,
        required: [true, 'Debe ingresar un nombre a la categoria']
...
tipoCategoriaSchema.plugin(uniqueValidator, {
...
module.exports = mongoose.model('TipoCategoria', tipoCategoriaSchema); // exportamos el schema para poderlo usar donde lo llamemos