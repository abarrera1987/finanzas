...
let iconosEgresosConcpetoSchema = new Schema({
...
iconosEgresosConcpetoSchema.plugin(uniqueValidator, {
...
module.exports = mongoose.model('iconosEgresosConcepto', iconosEgresosConcpetoSchema); // exportamos el schema para poderlo usar donde lo llamemos